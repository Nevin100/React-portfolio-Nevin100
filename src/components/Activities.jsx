  ...
  return (
    <div className="border-b border-neutral-900 pb-24 px-4 sm:px-8 lg:px-16">
      ...
      <motion.h2
        ...
        className="my-24 text-center text-3xl lg:text-6xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-sky-400 bg-clip-text text-transparent drop-shadow-md"
      >
