...
export default function Technologies({ sections }) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Technologies & Skills | Nevin Bali – Full Stack & GenAI Engineer
        </title>

        <meta
          name="description"
          content="Explore the technologies and skills used by Nevin Bali, a Full Stack Software Engineer specializing in JavaScript, TypeScript, React, Next.js, GenAI, DevOps, cloud platforms, and scalable system design."
        />

        <meta
          name="keywords"
          content="Nevin Bali skills, Full Stack Developer skills, GenAI Engineer tech stack, React Next.js developer, DevOps tools, Cloud technologies"
        />
      </Helmet>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-16 relative">
        ...
        <motion.h2
          ...
          className="text-center text-4xl md:text-6xl lg:text-7xl font-extrabold mb-16 pb-3 leading-tight
        ...
        <p className="text-center text-neutral-400 text-sm md:text-base mt-12">
          Continuously evolving — exploring Cloud, DevOps, CI/CD, and scalable
          system design.
        </p>
      </section>
    </>
